...
--
-- Name: elements unique_k; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT unique_k UNIQUE (symbol);


--
-- Name: elements unique_k2; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT unique_k2 UNIQUE (name);
...
ALTER TABLE ONLY public.properties
    ADD CONSTRAINT propfk FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);


--
-- Name: properties typeidfk; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT typeidfk FOREIGN KEY (type_id) REFERENCES public.types(type_id);
